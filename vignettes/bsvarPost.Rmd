...
For composition, the stacked view is the coherent decomposition plot: it adds an
explicit `Baseline` component so the displayed areas sum to the realised series
