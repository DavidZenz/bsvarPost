...
These final chunks are intentionally small and evaluated during the vignette
build so the rendered document includes actual tables and plots for the main
output families.
