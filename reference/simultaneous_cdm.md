...
#> 1 model1 simultaneous_cdm ttr      ttr         0  0.636  -0.712  1.98
#> 2 model1 simultaneous_cdm gs       ttr         0 -0.319  -1.67   1.03
#> 3 model1 simultaneous_cdm gdp      ttr         0 -0.205  -1.55   1.14
#> 4 model1 simultaneous_cdm ttr      gs          0  0      -1.35   1.35
#> 5 model1 simultaneous_cdm gs       gs          0  0.0330 -1.31   1.38
#> 6 model1 simultaneous_cdm gdp      gs          0  0.0342 -1.31   1.38
