...
#'
#' Plots effective sample sizes, admissibility weights, and associated warning
#' indicators for sign-restricted posterior distributions.
#'
#' @param object An acceptance-diagnostics table, or a `PosteriorBSVARSIGN`
