...
#'
#' If that returns no entries, reinstall the package with
...
#' `build_vignettes = TRUE`.
#'
#' @name bsvarPost-inference-and-comparison
#' @aliases bsvarPost-inference-and-comparison
#' @keywords internal
NULL
...
#' `build_vignettes = TRUE`.
#'
#' @name bsvarPost-historical-decomposition-events
#' @aliases bsvarPost-historical-decomposition-events
#' @keywords internal
NULL
...
#' `build_vignettes = TRUE`.
#'
#' @name bsvarPost-sign-restricted-workflows
#' @aliases bsvarPost-sign-restricted-workflows
#' @keywords internal
NULL
