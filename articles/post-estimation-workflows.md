...
``` r
compare_hd_event(baseline = post, alternative = post_alt, start = 1, end = 4)
```
...
``` r
compare_peak_response(baseline = post, alternative = post_alt, type = "irf", horizon = 12, variable = 1, shock = 1)
compare_duration_response(baseline = post, alternative = post_alt, type = "cdm", horizon = 12, variable = 1, shock = 1, relation = ">", value = 0)
compare_half_life_response(baseline = post, alternative = post_alt, type = "irf", horizon = 12, variable = 1, shock = 1)
compare_time_to_threshold(baseline = post, alternative = post_alt, type = "cdm", horizon = 12, variable = 1, shock = 1, relation = ">", value = 0)
...
|:-------|:-------------------|:-------------------|--------:|-------:|-------:|-------:|-------:|
| model1 | productivity       | productivity       |       0 |  0.000 |  0.000 |  0.000 |  0.000 |
| model1 | productivity       | productivity       |       1 | -0.013 | -0.013 | -0.013 | -0.013 |
| model1 | productivity       | productivity       |       2 | -0.030 | -0.030 | -0.030 | -0.030 |
| model1 | productivity       | productivity       |       3 | -0.040 | -0.040 | -0.040 | -0.040 |
| model1 | productivity       | stock_prices       |       0 | -0.423 | -0.423 | -0.423 | -0.423 |
| model1 | productivity       | stock_prices       |       1 | -0.459 | -0.459 | -0.459 | -0.459 |
| model1 | productivity       | stock_prices       |       2 | -0.473 | -0.473 | -0.473 | -0.473 |
| model1 | productivity       | stock_prices       |       3 | -0.471 | -0.471 | -0.471 | -0.471 |
| model1 | productivity       | consumption        |       0 |  0.621 |  0.621 |  0.621 |  0.621 |
| model1 | productivity       | consumption        |       1 |  0.610 |  0.610 |  0.610 |  0.610 |
| model1 | productivity       | consumption        |       2 |  0.626 |  0.626 |  0.626 |  0.626 |
| model1 | productivity       | consumption        |       3 |  0.638 |  0.638 |  0.638 |  0.638 |
| model1 | productivity       | real_interest_rate |       0 | -0.220 | -0.220 | -0.220 | -0.220 |
| model1 | productivity       | real_interest_rate |       1 | -0.102 | -0.102 | -0.102 | -0.102 |
| model1 | productivity       | real_interest_rate |       2 | -0.043 | -0.043 | -0.043 | -0.043 |
| model1 | productivity       | real_interest_rate |       3 | -0.018 | -0.018 | -0.018 | -0.018 |
| model1 | productivity       | hours_worked       |       0 | -0.072 | -0.072 | -0.072 | -0.072 |
| model1 | productivity       | hours_worked       |       1 | -0.164 | -0.164 | -0.164 | -0.164 |
| model1 | productivity       | hours_worked       |       2 | -0.146 | -0.146 | -0.146 | -0.146 |
| model1 | productivity       | hours_worked       |       3 | -0.134 | -0.134 | -0.134 | -0.134 |
| model1 | stock_prices       | productivity       |       0 |  5.644 |  5.644 |  5.644 |  5.644 |
| model1 | stock_prices       | productivity       |       1 |  6.175 |  6.175 |  6.175 |  6.175 |
| model1 | stock_prices       | productivity       |       2 |  5.742 |  5.742 |  5.742 |  5.742 |
| model1 | stock_prices       | productivity       |       3 |  5.552 |  5.552 |  5.552 |  5.552 |
| model1 | stock_prices       | stock_prices       |       0 | -3.645 | -3.645 | -3.645 | -3.645 |
| model1 | stock_prices       | stock_prices       |       1 | -4.215 | -4.215 | -4.215 | -4.215 |
| model1 | stock_prices       | stock_prices       |       2 | -4.915 | -4.915 | -4.915 | -4.915 |
| model1 | stock_prices       | stock_prices       |       3 | -5.345 | -5.345 | -5.345 | -5.345 |
| model1 | stock_prices       | consumption        |       0 | -3.405 | -3.405 | -3.405 | -3.405 |
| model1 | stock_prices       | consumption        |       1 | -3.474 | -3.474 | -3.474 | -3.474 |
...
| model1 | stock_prices       | hours_worked       |       3 | -0.010 | -0.010 | -0.010 | -0.010 |
| model1 | consumption        | productivity       |       0 | -0.015 | -0.015 | -0.015 | -0.015 |
| model1 | consumption        | productivity       |       1 |  0.032 |  0.032 |  0.032 |  0.032 |
| model1 | consumption        | productivity       |       2 |  0.034 |  0.034 |  0.034 |  0.034 |
| model1 | consumption        | productivity       |       3 |  0.026 |  0.026 |  0.026 |  0.026 |
| model1 | consumption        | stock_prices       |       0 | -0.075 | -0.075 | -0.075 | -0.075 |
| model1 | consumption        | stock_prices       |       1 | -0.103 | -0.103 | -0.103 | -0.103 |
| model1 | consumption        | stock_prices       |       2 | -0.124 | -0.124 | -0.124 | -0.124 |
| model1 | consumption        | stock_prices       |       3 | -0.139 | -0.139 | -0.139 | -0.139 |
| model1 | consumption        | consumption        |       0 | -0.129 | -0.129 | -0.129 | -0.129 |
| model1 | consumption        | consumption        |       1 | -0.212 | -0.212 | -0.212 | -0.212 |
| model1 | consumption        | consumption        |       2 | -0.246 | -0.246 | -0.246 | -0.246 |
...
| model1 | consumption        | hours_worked       |       2 | -0.299 | -0.299 | -0.299 | -0.299 |
| model1 | consumption        | hours_worked       |       3 | -0.294 | -0.294 | -0.294 | -0.294 |
| model1 | real_interest_rate | productivity       |       0 | -0.951 | -0.951 | -0.951 | -0.951 |
| model1 | real_interest_rate | productivity       |       1 | -0.342 | -0.342 | -0.342 | -0.342 |
| model1 | real_interest_rate | productivity       |       2 | -0.315 | -0.315 | -0.315 | -0.315 |
| model1 | real_interest_rate | productivity       |       3 | -0.252 | -0.252 | -0.252 | -0.252 |
| model1 | real_interest_rate | stock_prices       |       0 | -1.197 | -1.197 | -1.197 | -1.197 |
| model1 | real_interest_rate | stock_prices       |       1 | -0.740 | -0.740 | -0.740 | -0.740 |
| model1 | real_interest_rate | stock_prices       |       2 | -0.542 | -0.542 | -0.542 | -0.542 |
| model1 | real_interest_rate | stock_prices       |       3 | -0.388 | -0.388 | -0.388 | -0.388 |
| model1 | real_interest_rate | consumption        |       0 | -0.740 | -0.740 | -0.740 | -0.740 |
| model1 | real_interest_rate | consumption        |       1 | -0.483 | -0.483 | -0.483 | -0.483 |
| model1 | real_interest_rate | consumption        |       2 | -0.347 | -0.347 | -0.347 | -0.347 |
| model1 | real_interest_rate | consumption        |       3 | -0.254 | -0.254 | -0.254 | -0.254 |
| model1 | real_interest_rate | real_interest_rate |       0 | -0.630 | -0.630 | -0.630 | -0.630 |
...
| model1 | hours_worked       | productivity       |       0 |  0.110 |  0.110 |  0.110 |  0.110 |
| model1 | hours_worked       | productivity       |       1 |  0.136 |  0.136 |  0.136 |  0.136 |
| model1 | hours_worked       | productivity       |       2 |  0.163 |  0.163 |  0.163 |  0.163 |
| model1 | hours_worked       | productivity       |       3 |  0.163 |  0.163 |  0.163 |  0.163 |
| model1 | hours_worked       | stock_prices       |       0 |  0.275 |  0.275 |  0.275 |  0.275 |
| model1 | hours_worked       | stock_prices       |       1 |  0.293 |  0.293 |  0.293 |  0.293 |
| model1 | hours_worked       | stock_prices       |       2 |  0.268 |  0.268 |  0.268 |  0.268 |
...
The site also includes a small set of pre-rendered sign-restriction
figures generated from richer posterior samples. This keeps the checked
vignette build light while still showing smoother diagnostics and
event-window plots.
