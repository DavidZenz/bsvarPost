...
expected_names <- rownames(post1$last_draw$data_matrices$Y)
expect_equal(sort(unique(irf_tbl$variable)), sort(expected_names))
expect_equal(sort(unique(irf_tbl$shock)), sort(expected_names))
...
expect_equal(sort(unique(cdm_tbl$shock)), sort(expected_names))
expect_equal(sort(unique(fevd_tbl$shock)), sort(expected_names))
expect_equal(sort(unique(sh_tbl$variable)), sort(expected_names))
expect_equal(sort(unique(hd_tbl$variable)), sort(expected_names))
expect_equal(sort(unique(hd_tbl$shock)), sort(expected_names))
